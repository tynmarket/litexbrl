  ...
  module TDnet
    describe Summary do
      ...
      describe '.find_accounting_base' do
        context '日本会計基準' do
          it do
            accounting_base = Summary.send(:find_accounting_base, doc("#{dir}/ja-cons-2013-q1.xbrl"), nil, nil)
        ...
        context '米国会計基準' do
          it do
            accounting_base = Summary.send(:find_accounting_base, doc("#{dir}/us-cons-2014-q1.xbrl"), nil, nil)
        ...
        context 'IFRS' do
          it do
            accounting_base = Summary.send(:find_accounting_base, doc("#{dir}/if-cons-2014-q1.xbrl"), nil, nil)
